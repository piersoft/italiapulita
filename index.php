...
overflow-x: hidden;
	...
	<body>
		...
		<div id="infodiv" style="leaflet-popup-content-wrapper">
			<p><b>Segnalazioni di degrado urbano<br></b>
			Segnalazioni inviate tramite <a href="https://telegram.me/italiapulitabot" targer="_blank">@italiapulitabot</a> su Telegram - by @piersoft</br></p>
		</div>
...
var bankias = L.geoCsv(null, {firstLineTitles: true, fieldSeparator: ',',
	...
	if (feature.properties.file_id.length > 1){
		...
		immagine='http://www.piersoft.it/italiapulitabot/allegato.php?id='+feature.properties.file_id;

		popup += '<b><img src='+immagine+' style="width:250px;" alt="25"/></b><br /><b><a href="http://www.piersoft.it/italiapulitabot/allegato.php?id='+feature.properties.file_id+'" />Scarica allegato</a></b><br />';
